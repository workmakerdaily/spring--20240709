...
import com.ksy.springbasic.service.BasicService;
...
public class ServiceController {
    ...
    // - spring framwork에서 권장하고 있는 의존성 주입 방법은 생성자를 통한 의존성 주입 (의존성이 주입되지 않은 상태가 존재할 수 없기 때문)
    // - spring framwork에서 IoC을 통해 의존성을 주입할 땐 주입할 인스턴스의 클래스가 Spring bean으로 등록되어있어야 함
