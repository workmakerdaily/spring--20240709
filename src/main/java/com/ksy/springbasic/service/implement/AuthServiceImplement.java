...
import com.ksy.springbasic.entity.SampleUserEntity;
import com.ksy.springbasic.provider.JwtProvider;
import com.ksy.springbasic.repository.SampleUserRepository;
import com.ksy.springbasic.service.AuthService;
...
public class AuthServiceImplement implements AuthService {
    ...
    // - boolean matches(평문비밀번호, 암호화된비밀번호): 평문 비밀번호와 암호화된 비밀번호가 일치하는지 여부를 반환
    ...
    public String signUp(PostUserRequestDto dto) {
        ...
        try {
            ...
            // SampleUserEntity userEntity = new SampleUserEntity(userId, password, name, address, telNumber); // 오류를 감지하기 어려움

            // SampleUserEntity userEntity = new SampleUserEntity();
            // userEntity.setUserId(userId); // entity는 원래 set을 가지면 안됨
